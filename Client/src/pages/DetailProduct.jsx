...
const DetailProduct = () => {
  ...
  const { data, error, isLoading } = useGetProductdetailQuery(parseInt(productId));
        ...
        {data ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-green-600 mb-4">${data.price}</p>
              <p className="text-lg text-gray-600 mb-6">Category: {data.category.name}</p>
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li className="text-gray-600">Dimensions: 12 x 10 x 6 inches</li>
...
<div className="mt-16">
  ...
  <div className="mb-8">
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center space-x-2">
        ...
        <div className="w-full bg-gray-200 rounded-full h-2.5">
          <div className="bg-yellow-200 h-2.5 rounded-full" style={{ width: "5%" }}></div>
        </div>
      </div>
      <div className="flex items-center space-x-2">
        <span className="text-gray-600">1⭐:</span>
        <div className="w-full bg-gray-200 rounded-full h-2.5">
          <div className="bg-yellow-100 h-2.5 rounded-full" style={{ width: "5%" }}></div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="mb-8">
    <h3 className="text-2xl font-semibold text-gray-800 mb-4">Additional Offers</h3>
    <div className="space-y-4">
      <div className="flex items-center space-x-2">
        <span className="text-green-600">🚚</span>
        <span className="text-gray-600">Free Home Delivery on orders above $50</span>
      </div>
      <div className="flex items-center space-x-2">
        <span className="text-red-600">🔄</span>
        <span className="text-gray-600">Free 30-Day Replacement</span>
      </div>
      <div className="flex items-center space-x-2">
        <span className="text-yellow-500">💳</span>
        <span className="text-gray-600">10% Bank Offer on HDFC Cards</span>
      </div>
    </div>
  </div>
  ...
  <div className="mb-8">
    ...
    <p className="text-lg text-gray-600">{data.description}</p>
          ...
          <p className="text-center text-lg text-gray-500">No product details found.</p>
        )}
      </div>
    </Layout>
  );
